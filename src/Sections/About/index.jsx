        ...
        <section className={`w-full text-white font-poppins`}>
            ...
            <div className="w-full mt-24 flex flex-col items-center">
               <Button className="button" data-text="Awesome">
                ...
                <div className="grid grid-cols-2 gap-8 place-items-center sm:grid-cols-3 lg:grid-cols-6 max-w-[70%] sm:gap-6 mt-10">
                    <div>
                        <Img className="hover:-translate-y-2.5 transition-all duration-300 ease-in" src="https://skillicons.dev/icons?i=html,tailwindcss" alt="html-5--v1"/>
                        <p htmlFor="html-5--v1" className="text-xs mt-1 text-center">HTML5, TAILWINDCSS</p>
                    </div>
                    <div>
                        ...
                        <p htmlFor="" className="text-xs text-center mt-1">JAVASCRIPT, REACT</p>
                    </div>
                    <div>
                        ...
                        <p htmlFor="" className="text-xs text-center mt-1">TYPESCRIPT, NEXTJS</p>
                    </div>
                    <div>
                        <Img className="hover:-translate-y-2.5 transition-all duration-300 ease-in" src="https://skillicons.dev/icons?i=nodejs,postgres" alt="" />
                        <p htmlFor="" className="text-xs mt-1 text-center">NODEJS, POSTGRES</p>
                    </div>
                    <div>
                        <Img className="hover:-translate-y-2.5 transition-all duration-300 ease-in" src="https://skillicons.dev/icons?i=git,vercel" alt="" />
                        <p htmlFor="" className="text-xs text-center mt-1">GIT, VERCEL</p>
                    </div>
                    <div>
                        <Img className="hover:-translate-y-2.5 transition-all duration-300 ease-in" src="https://skillicons.dev/icons?i=supabase,mongodb" alt="" />
                        <p htmlFor="" className="text-xs mt-1 text-center">SUPABASE, MONGODB</p>
                    </div>
                </div>
            </div>
            </div>
